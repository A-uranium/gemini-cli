...
| Force Alternate Buffer               | `ui.compatibility.forceAltBuffer`        | Force enable the alternate screen buffer even in potentially buggy terminals.                                                                                     | `false`  |
| Disable Alternate Buffer             | `ui.compatibility.disableAltBuffer`      | Disable the alternate screen buffer globally.                                                                                                                     | `false`  |
| Disable Mouse Support                | `ui.compatibility.disableMouse`          | Disable mouse event tracking.                                                                                                                                     | `false`  |
| Assume Trusted Terminal              | `ui.compatibility.assumeTrustedTerminal` | Assume the terminal is fully capable and skip capability fallbacks.                                                                                               | `false`  |
